...
parser = argparse.ArgumentParser('retweet')
...
outpath = create_outpath('retweet')
...
if __name__ == '__main__':
    ...
    train_time, train_type, train_num_types, train_seq_lengths, train_mask = \
        process_loaded_sequences(device=device, source_dir='../data/retweet/train.pkl', split='train')
    dev_time, dev_type, dev_num_types, dev_seq_lengths, dev_mask = \
        process_loaded_sequences(device=device, source_dir='../data/retweet/dev.pkl', split='dev')
    test_time, test_type, test_num_types, test_seqs_lengths, test_mask = \
        process_loaded_sequences(device=device, source_dir='../data/retweet/test.pkl', split='test')
