...
if __name__ == '__main__':
    ...
    dev_time, dev_type, dev_num_types, dev_seq_lengths = \
        build_input_from_pkl(device=device, source_dir='../data/mimic2/dev.pkl', split='dev')
    test_time, test_type, test_num_types, test_seqs_lengths = \
        build_input_from_pkl(device=device, source_dir='../data/mimic2/test.pkl', split='test')
